...
class TestView(dt.TestCase):
    def test_missing_action(self):
        ...
        r.assertEqualResponses(response, c.responses.INCORRECT_TOKEN_PARAMETER)
    ...
    def test_with_incorrect_user(self):
        ...
        r.assertEqualResponses(response, c.responses.INCORRECT_USER)
    ...
    def test_with_incorrect_password(self):
        ...
        r.assertEqualResponses(response, c.responses.INCORRECT_PASSWORD)
